			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<h4 class="header green">STORE PROCEDURE EXECUTOR KEYSOFT </h4>
						</div><!-- /.page-header -->

						<div class="row">
							<div class="col-xs-12">
								<!-- PAGE CONTENT BEGINS -->
								<form action="executorformitemtransfer" method="POST" class="form-horizontal" role="form">
									<div class="row">
										<div class="col-sm-4">
												...
												<div class="widget-body">
													<div class="widget-main">
														...
														<div class="row">
															<div class="col-xs-8 col-sm-11">
																<div class="input-group">
																	<input class="form-control" id="id-date-picker-1" type="text" name="TransactionNo" value="<?php echo $_GET['TransactionNo']; ?>" readonly />
														...
														<div class="row">
															<div class="col-xs-8 col-sm-11">
																<div class="input-group">
																	<input class="form-control date-picker" id="id-date-picker-1"  name="Date1" type="text" value="<?php echo $date ?>" data-date-format="yyyy-mm-dd" />
																	<span class="input-group-addon">
