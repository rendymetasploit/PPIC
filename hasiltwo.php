														...
														<div class="table-responsive">
															<table class="table table-striped table-bordered table-hover" id="dataTables-example">
																...
																<tbody>
																	...
																	<tr class="gradeX">
																	  <td>Borghi A ( Yield ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Boucherie B (Hasil Produksi)</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Boucherie B ( BS ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Boucherie B ( Yield ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Boucherie C (Hasil Produksi)</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Boucherie C ( BS ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Boucherie C ( Yield ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Haixing D (Hasil Produksi)</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	...
																	<tr class="gradeX">
																	  <td>Haixing D ( Yied ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Borghi E ( Hasil Produksi )</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	...
																	<tr class="gradeX">
																	  <td>Borghi E ( Yield  ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Borghi F ( Hasil Produksi )</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	...
																	<tr class="gradeX">
																	  <td>Borghi F ( Yield ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Borghi G ( Hasil Produksi )</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	...
																	<tr class="gradeX">
																	  <td>Borghi G ( Yield ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Serut TA ( Hasil Produksi )</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	...
																	<tr class="gradeX">
																	  <td>Serut TA ( Yield ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Serut TB ( Hasil Produksi )</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	...
																	<tr class="gradeX">
																	  <td>Serut TB ( Yield ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Serut TC ( Hasil Produksi )</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	...
																	<tr class="gradeX">
																	  <td>Serut TC ( Yield ) %</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
																	  <td>Serut TD ( Hasil Produksi )</td>
																	  <td>&nbsp;</td>
																	  <td>&nbsp;</td>
																  </tr>
																	<tr class="gradeX">
