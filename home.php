...
if (empty($_SESSION['kode_user']) AND empty($_SESSION['id']) AND empty($_SESSION['nama']) AND empty($_SESSION['passuser']) AND $_SESSION['login']==0){
								...
								<div class="row">
									<div class="col-sm-5">
										<div class="widget-box transparent">
											<div class="row">
												<div class="col-xs-12">
													<h3 class="header smaller lighter green">ALUR</h3>

													<p></p>
													
													<a href="manufac" class="btn btn-primary btn-app radius-4">
														<i class="ace-icon fa fa-industry bigger-230"></i>
														Manufactur
														<span class="badge badge-pink"></span>
													</a>
													
													<i class="ace-icon	fa fa-angle-double-right bigger-230"></i>
													
													<a href="mesin" class="btn btn-success btn-app radius-4">
													...
													<a href="formitemtransfer" class="btn btn-danger btn-app radius-4">
