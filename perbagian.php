											...
											<div class="col-md-12">
												...
												<div class="panel panel-default">
													<div class="table-header">
														PENCAPAIAN HASIL PRODUKSI ( PCS ) DIVISI SIKAT PERIODE AGUSTUS 2019
													</div>
									...
									<div class="col-xs-12">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<div class="panel panel-default">
													<div class="table-header">
														HASIL RATA-RATA PENCAPAIAN BS ( % ) DIVISI SIKAT PERIODE AGUSTUS 2019
													</div>
													<div class="panel-body">
														<div class="table-responsive">
															<table class="table table-bordered">
									...
									<div class="col-xs-12">
										...
										<div class="row">
											<div class="col-md-12">
												...
												<div class="panel panel-default">
													<div class="table-header">
														HASIL RATA-RATA PENCAPAIAN YIELD ( % ) DIVISI SIKAT PERIODE AGUSTUS 2019
													</div>
													<div class="panel-body">
														<div class="table-responsive">
														  <table class="table table-bordered">
