													...
													<div class="panel-body">
														<div class="table-responsive">
															<table class="table table-striped table-bordered table-hover" id="dataTables-example">
																...
																<tbody>
																<?php include "config/koneksione.php";
																...
																$tsql = "select
																		...
																		from
																		trans_workorder a
																		inner join Ms_FormulaHD b on b.FormulaID = a.FormulaID WHERE a.DivisionID='".$_SESSION['kode']."'";
																...
																?>	
																	<tr class="gradeX">
																	  <td><a href='form?TransactionNo=<?= $row['TransactionNo'];?>'><?= $row['TransactionNo'];?></a></td>
																	  <td><?= $Date = $row['TransactionDate']->format('d/m/Y');?></td>
